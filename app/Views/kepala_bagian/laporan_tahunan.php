            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('kepala-bagian/laporan-tahunan'); ?>" method="GET" class="mb-4">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-auto mt-3 mt-md-0">
                                    <a href="<?= base_url('kepala-bagian/laporan/export-pdf?filter_type=tahunan&tahun=' . $tahun); ?>"
